/****** Object:  Procedure [dbo].[uspValidateNewPrimaryPosition]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[uspValidateNewPrimaryPosition](@editId int, @employeeid int, @positionid int, @datefrom datetime, @dateto datetime)
AS
BEGIN
