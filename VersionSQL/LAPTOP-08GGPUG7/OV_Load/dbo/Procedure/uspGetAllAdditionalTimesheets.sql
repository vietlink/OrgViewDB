/****** Object:  Procedure [dbo].[uspGetAllAdditionalTimesheets]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[uspGetAllAdditionalTimesheets](@search varchar(255), @filterPayCycleId int, @filterEmpId int, @statusList varchar(255), @sortApproveList varchar(50), @hideApproved bit)
AS
BEGIN
