/****** Object:  Procedure [dbo].[uspGetPermission]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE procedure [dbo].[uspGetPermission](@roleids varchar(100),@Code varchar(100))  
as  
begin
