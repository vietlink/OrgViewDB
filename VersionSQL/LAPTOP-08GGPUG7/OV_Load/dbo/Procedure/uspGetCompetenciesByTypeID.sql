/****** Object:  Procedure [dbo].[uspGetCompetenciesByTypeID]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[uspGetCompetenciesByTypeID](@typeid int, @filterEnabled int = 0, @employeeId int = 0, @isCompliance int = 0, @positionid int)
AS
BEGIN
