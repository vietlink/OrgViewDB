...
-- =============================================
CREATE PROCEDURE [dbo].[uspCreateTransactionFromHeader](@headerId int, @originalDate varchar(max) = '')
AS
BEGIN
	...
	--declare @original datetime=convert(datetime, @originalDate, 120)
	...
	--if (@originalDate!='') BEGIN
	--	exec uspRegenAccrueData @original, @EmployeeID
	--	exec uspRegenAccrueDataByTimesheet @original, @EmployeeID
	--END
	...
	exec dbo.uspRegenAccrueData @dateFrom, @EmployeeID
END
