/****** Object:  Procedure [dbo].[uspGetAwaitingTeamExpenseHeader]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- Description:	
-- =============================================
CREATE PROCEDURE [dbo].[uspGetAwaitingTeamExpenseHeader] 
	-- Add the parameters for the stored procedure here
	@managerID int, @approverPosID int,  @personID int, @empIDList varchar(max), @statusList varchar(max)
AS
BEGIN
	...
	GROUP BY  ech.id, ech.ExpenseClaimDate, ech.Description, es.Description, es.Code, e.displayname, p.title, ech.isLocked, ech.EmployeeID, ech.isPartiallyApproved, ech.Comment
	, pc.Description
