/****** Object:  Procedure [dbo].[uspGetWorkedHourFiguresByHours]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[uspGetWorkedHourFiguresByHours](@empId int, @dateFrom datetime, @hours decimal(10,5), @takenBreakMinutes decimal(10,5))
AS
BEGIN
	...
	DECLARE @workDayHours decimal(10,5) = dbo.fnGetHoursInDay(@empId, @dateFrom);
	--SET @workDayHours += @extraHours;

	DECLARE @timeWorked decimal(10,5) = @hours - @takenBreakMinutes
