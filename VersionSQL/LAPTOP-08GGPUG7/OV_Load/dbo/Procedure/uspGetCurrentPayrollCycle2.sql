/****** Object:  Procedure [dbo].[uspGetCurrentPayrollCycle2]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[uspGetCurrentPayrollCycle2](@empId int, @date DateTime)
AS
BEGIN
