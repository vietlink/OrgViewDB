/****** Object:  Procedure [dbo].[uspUpdateAllCountsBlocking]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE PROCEDURE [dbo].[uspUpdateAllCountsBlocking] (@jobName varchar(30) = '')
AS
BEGIN
