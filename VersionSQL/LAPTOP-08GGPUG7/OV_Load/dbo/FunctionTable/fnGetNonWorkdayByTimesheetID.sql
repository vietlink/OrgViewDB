/****** Object:  Function [dbo].[fnGetNonWorkdayByTimesheetID]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- Description:	
-- =============================================
CREATE FUNCTION fnGetNonWorkdayByTimesheetID 
(
...
(
	...
	timesheetID int, _date datetime 
...
BEGIN
	...
	END	
	INSERT INTO @result 
	SELECT @timesheetID, t._tempDate 
	FROM @temp t 
