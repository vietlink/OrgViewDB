/****** Object:  Function [dbo].[fnGetWorkHourHeaderIDByDayFirm]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE FUNCTION [dbo].[fnGetWorkHourHeaderIDByDayFirm](@empId int, @date datetime)
RETURNS int
AS
BEGIN
    DECLARE @id int;
