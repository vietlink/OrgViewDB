/****** Object:  Function [dbo].[fnIsPublicHolidayAfterNonWorkDay]    Committed by VersionSQL https://www.versionsql.com ******/
...
-- =============================================
CREATE FUNCTION [dbo].[fnIsPublicHolidayAfterNonWorkDay](@empId int, @date DateTime)
RETURNS bit
AS
BEGIN
	...
	DECLARE @EndDate DateTime = DATEADD(day, -1, @nextPublicHoliday);
